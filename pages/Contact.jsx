  ...
  return (
    <div className='bg-white pt-32 '>
      <div className='flex flex-col md:flex-row-reverse py-6 px-6 md:gap-20 md:px-28'>
        <div className=' md:flex-1' data-aos="fade-up"><img src={contact} className='w-fit hidden md:flex' alt="contact-image" /></div>
      ...
      <div className=" md:px-32 px-6 flex gap-10 flex-col items-center justify-center md:py-12 py-6">
        ...
        <p className="text-gray-500 text-sm text-center" data-aos="fade-up">Our friendly team would love to hear from you.</p>
        <form className='capitalize form flex flex-col gap-5 md:w-[600px]' onSubmit={e => e.preventDefault()}>
          ...
          <button disabled={isDisabled} className={`w-full py-3 text-white ${isDisabled ? 'bg-gray-400' : 'bg-greener'}`} data-aos="fade-up">send message</button>
        </form>
      </div>
    </div>
  )
