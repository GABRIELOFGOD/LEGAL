  ...
  return (
    <div className=' fixed flex items-center justify-center z-50 top-0 left-0 h-full w-full bg-black bg-opacity-70'>
      <div className='flex flex-col px-6 md:py-20 bg-white h-[80%] relative w-[90%] py-10 gap-2 items-center justify-center'>
        ...
        <p className="text-center text-textSecondary text-sm mb-5" data-aos="fade-up">Kindly provide the following informations to keep track on your case</p>
        <form onSubmit={e => caseTrackingRequest(e)} className="flex md:w-[350px] w-full flex-col gap-5">
            ...
            <input value={trackCode} onChange={e => setTrackCode(e.target.value)} type="text" placeholder='The case code that was given to your on report' className='w-full text-xs py-3 px-5 outline-none border-2 border-primary' data-aos="fade-up" />
