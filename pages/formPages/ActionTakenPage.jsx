...
const ActionTakenPage = ({activePage, btnDisabled, setBtnDisabled, setPage, actionTaken, setTaken}) => {
  ...
  return (
    <div className='flex flex-col items-center gap-5'>
        <div className="flex flex-col">
          ...
          <select value={actionTaken} onChange={e => setTaken(e.target.value)} defaultValue='non' className='w-full border-none outline-none bg-gray-300 py-2 px-6 flex flex-col gap-5 rounded-sm' name="evidence" id="evidence">
