...
const FormReview = () => {
  ...
  return (
    <div className={`fixed flex flex-col items-center justify-center px-2 top-0 left-0 bg-white bg-opacity-85 w-[100vw] h-[100vh] z-50 ${review ? 'flex' : 'hidden'}`}>
      <div className="bg-white md:px-20 px-3 py-20 rounded-md shadow-md flex flex-col items-center justify-center gap-5 relative w-full md:max-w-[600px] max-h-[90%]">
        ...
        <div className='flex w-full gap-3 flex-col'>
          ...
          {/* <div className='flex justify-between flex-col gap-5 md:grid grid-cols-2'> */}
            <div className="flex gap-3 justify-between">
              <p className="text-primary font-semibold">Action You've Taken:</p>
