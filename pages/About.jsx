...
const About = () => {
  ...
  return (
    <div>
      <div className='about flex flex-col justify-center items-center px-3' data-aos="fade-right">
        <p className="font-bold text-6xl uppercase text-white z-20" data-aos="fade-up">About SafeLegal</p>
      </div>

      <div className='md:px-24 px-6 py-10'>
        <div className='flex flex-col md:flex-row justify-between gap-10'>
          <div className='flex-1 md:p-10' data-aos="fade-right"><img src="/images/about.jpg" alt="" /></div>
          <div className='flex my-auto flex-1 flex-col gap-10'>
            ...
            <p className='text-xl' data-aos="fade-up">SafeLegal is an annex of SAFERNET built to help and aid victims of abuse and to give voice to the violence casualties of any type of abuse in any form anywhere and anytime.</p>
        ...
        <div className='flex flex-col pt-20 md:flex-row-reverse justify-between gap-10'>
          <div className='flex-1 p-10 hidden md:flex' data-aos="fade-up"><img src="/images/faq.jpg" alt="" /></div>
          <div className='flex my-auto flex-1 flex-col gap-10'>
            <p className="text-3xl text-left text-primary font-bold" data-aos="fade-down">FAQs</p>
