...
const Footing = () => {
  return (
    <div className='bg-primary flex flex-col md:flex-row justify-between gap-10 mt-10 md:py-20 md:px-32 py-6 px-6'>
      <Link to='/' className='font-extrabold text-white text-4xl'>A</Link>
      {/* <Link to='/' onClick={closeNav} className='font-extrabold text-primary text-4xl'>SAFERNET(annex)</Link> */}
      <div className='flex ting flex-col gap-5 capitalize text-white'>
        {
          navList.map((item, i) => (
      ...
      <div className='flex flex-col gap-5 capitalize text-white'>
        {
          social.map((item, i) => (
