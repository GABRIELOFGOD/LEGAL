...
const Layout = () => {
  ...
  return (
    <div>
      ...
      <ScrollRestoration />
      <Outlet />
      <button onClick={() => setBot(true)} className='rounded-full bot bg-primary h-[50px] w-[50px] flex items-center justify-center fixed shadow-textSecondary md:bottom-20 bottom-10 right-10 md:right-20 shadow-sm z-30'>
