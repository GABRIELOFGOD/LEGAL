  ...
  return (
    <div className='w-full rounded-md overflow-hidden px-6 md:px-32'>
      <div className="relative internet flex flex-col items-center justify-center h-[300px] overflow-hidden w-full">
        <div className='w-full absolute h-full bg-cover rounded-md ' style={{background: `url(${internet})`, backgroundSize: 'cover'}} data-aos="fade-right"></div>
        <div className='z-20 flex flex-col items-center justify-center text-center' data-aos="fade-left">
